...
-->
<div class="col-12 card" style="marging: 0; width: 100%; box-shadow: 2px 0px 1px 2px rgba(22, 22, 26, 0.18);">
<footer>
    <div class="container">
        <div class="row" style="padding: 20px 0;">
			...
			<div class="col-md-3" style="line-height: 24px;">
                ...
                <p class="" style="font-size: 14px; line-height: 28px;">
					...
					<span>
						<i class="fa fa-long-arrow-right" aria-hidden="true"></i><a href="javascript:;"> โรงแรม </a>
					</span><br/>
					<span>
						<i class="fa fa-long-arrow-right" aria-hidden="true"></i><a href="javascript:;"> คอนโด & อพาร์ทเมนต์ </a>
					</span><br/>
					<span>
						<i class="fa fa-long-arrow-right" aria-hidden="true"></i><a href="javascript:;"> โปรโมชั่น & แพ็คเกจ </a>
					</span>
                </p>
            </div>
            <div class="col-md-4 mt-2" style="line-height: 24px;">
                ...
                <p class="text-dark" style="font-size: 14px; line-height: 28px;">
					...
					<strong class="col-xs-2" >
						<span>&nbsp;&nbsp;บริษัท อินสตอลไดเรค จำกัด</span><br>
						<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 905/7 ถนนพระราม 3 แขวงบางโพงพาง</span><br>
                ...
                <p class="text-dark" style="font-size: 14px; line-height: 28px;">
					...
					<a class="text-dark" href="tel:026834900">
                ...
                <p class="text-dark" style="font-size: 14px; line-height: 28px;">
					...
					<!--<i class="fab fa-line" style="font-size:19px;"></i>-->
					<span>&nbsp;&nbsp;ไลน์ไอดี :</span>
        ...
        <div class="row">
            <div class="col-md-12">
                <p class="text-center">© 2024 RoomScope. All Rights Reserved.</p>
            </div>
        </div>
		-->
    </div>
