...
@media (max-width: 767px) {
    ...
    #value_left, #value_right {
        text-align: center;
        margin-bottom: 10px; /* เพิ่มช่องว่างระหว่างลิงก์ในหน้าจอเล็ก */
    }
}
</style> 
        ...
        <form name="frm_login" id="frm_login" class="user" method="post" action="<?php //echo site_url('login');?>">
            <div class="row my-3 d-flex justify-content-center">
                <div class="col-sm-12 col-md-6">
                    <label class="form-label" for="email"><span class="required">*</span>ชื่อผู้ใช้งาน</label>
            ...
            <div class="row my-3 d-flex justify-content-center">
                <div class="col-sm-12 col-md-6">
                    <label class="form-label" for="password"><span class="required">*</span>รหัสผ่าน</label>
            ...
            <div class="row  d-flex justify-content-center">
                <div class="col-sm-12 col-md-6 text-center">
                    <button name="login_btn" class="btn button-primary btn-user btn-block">ลงชื่อเข้าใช้งาน</button>
                </div>
            </div>

            <div class="row my-3 d-flex justify-content-center">
                <div class="col-sm-12 col-md-6 text-center">
                    <!-- <button name="login_btn" class="btn button-primary btn-user btn-block">Login with facebook</button> -->
                     <button name="login_btn" style="background-color: #3b5998 !important;" class="btn btn-user btn-block">
            ...
            <div class="row my-3 d-flex justify-content-center">
                <div class="col-sm-12 col-md-6 text-center">
                     <button name="login_btn" style="background-color: #db4437 !important;" class="btn btn-user btn-block">
            ...
            <div class="row d-flex justify-content-center mt-3">
                <div class="col-md-6 text-center">
                    <div class="row mx-2 d-flex justify-content-between">
                        <div class="col-md-6" id="value_left" >
                            <!-- class="text-align-center" -->
                            <div >
                                <a class="forgot_pass" href="javascript:;">ลืมรหัสผ่าน</a>
                            </div> 
                        </div>

                        <div class="col-md-6" id="value_right">
                            <!-- class="text-center" -->
                            <div >
                                <a class="" href="#">ลงทะเบียนเข้าใช้งาน<?php //echo $this->lang->line('register_here');?></a>
                            </div>
                        </div>
